      ...
      <section className="max-w-7xl mx-auto px-6 py-16 md:py-24 grid md:grid-cols-[1fr_400px] gap-12 items-center">
        <div>
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <a href="https://discord.gg/BeFN78k5b" target="_blank" rel="noreferrer" className="btn-secondary flex items-center gap-2 border-[#5865F2] text-[#5865F2] hover:bg-[#5865F2] hover:text-white">
            ...
            <Link to="/rejections" className="btn-secondary border-roach-coral text-roach-coral hover:bg-roach-coral hover:text-white">Submit Your Rant</Link>
          </div>
        </div>
